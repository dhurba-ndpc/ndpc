...
<div class="container-fluid px-0">
    ...
    <div class="page-header-container">
        <div>
            ...
            <h1 class="h4 mb-0 text-gray-800 font-weight-bold d-flex align-items-center">
                ...
                {{ isset($post) ? 'Edit Hero Banner' : 'Add New Hero Banner' }}
                @if(isset($post))
                    <span class="badge badge-info ml-2" style="font-size: 0.75rem;">ID: #{{ $post->id }}</span>
                @endif
            </h1>
        </div>
        <div>
    ...
    <!-- Main Form Starts -->
    <form id="heroBannerForm" action="{{ isset($post) ? route('hero-banners.update', $post->id) : route('hero-banners.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @if(isset($post))
            @method('PUT')
        @endif
            ...
            <div class="col-xl-5 col-lg-6 mb-4">
                ...
                <div class="custom-card mb-4">
                    ...
                    <div class="card-body p-3">
                        ...
                        @php
                            $hasImage = isset($post) && $post->image;
                            $imageUrl = $hasImage ? asset('storage/' . $post->image) : '';
                        @endphp
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('title_en', isset($post) ? ($post->translations->firstWhere('locale', 'en')?->title ?? '') : '') }}" 
                                               maxlength="255"
                                               required>
                                    </div>
                                    @error('title_en')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('title_ne', isset($post) ? ($post->translations->firstWhere('locale', 'ne')?->title ?? '') : '') }}"
                                               maxlength="255">
                                    </div>
                                    @error('title_ne')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group input-group-custom">
                                    ...
                                    <input type="number" 
                                           ...
                                           placeholder="1" 
                                           min="0"
                                           value="{{ old('position', isset($post) ? $post->position : '1') }}">
                                </div>
                                @error('position')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                @php
                                    $isActive = old('is_active', isset($post) ? $post->is_active : 1);
                                @endphp
                ...
                <div class="custom-card">
                    <div class="card-body p-3 d-flex align-items-center">
                        <button type="submit" id="submitBtn" class="btn btn-gradient-primary mr-2">
                            <i class="fas fa-save mr-1"></i> {{ isset($post) ? 'Update Banner' : 'Publish Banner' }}
                        </button>
